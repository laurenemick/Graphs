...
class SocialGraph:
    ...
    def populate_graph(self, num_users, avg_friendships):
        ...
        # # Annother way:
        # possible_friendships = []
        # friendship_used = set() # order n space
        ...
        #         possible_friendships.append((user_id, friend_id))
        #         friendship_used.add((user_id, friend_id))
    ...
    # faster with smaller inputs:
    # as the users : friendships ratio grows, you will get increasing amount of duplicates with random numbers
